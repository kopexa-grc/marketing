...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_pages_blocks_promo_card_link_type" AS ENUM('reference', 'custom');
  ...
  CREATE TYPE "public"."enum__pages_v_blocks_promo_card_link_type" AS ENUM('reference', 'custom');
  ...
  CREATE TYPE "public"."enum_main_menu_tabs_nav_items_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum_main_menu_tabs_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum_main_menu_ctas_link_type" AS ENUM('reference', 'custom');
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_promo_card" (
  	...
  	"heading" varchar,
  	"description" varchar,
  	"link_type" "enum_pages_blocks_promo_card_link_type" DEFAULT 'reference',
  	"link_new_tab" boolean,
  	"link_url" varchar,
  	"link_label" varchar,
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_promo_card" (
  	...
  	"heading" varchar,
  	"description" varchar,
  	"link_type" "enum__pages_v_blocks_promo_card_link_type" DEFAULT 'reference',
  	"link_new_tab" boolean,
  	"link_url" varchar,
  	"link_label" varchar,
  ...
  CREATE TABLE IF NOT EXISTS "main_menu_tabs_nav_items" (
  	...
  	"label" varchar NOT NULL,
  	"description" varchar,
  	"link_type" "enum_main_menu_tabs_nav_items_link_type" DEFAULT 'reference',
  	"link_new_tab" boolean,
  	"link_url" varchar
  );
  ...
  CREATE TABLE IF NOT EXISTS "main_menu_ctas" (
  	...
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"link_type" "enum_main_menu_ctas_link_type" DEFAULT 'reference',
  	"link_new_tab" boolean,
  	"link_url" varchar,
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_pages_blocks_promo_card_link_type";
  ...
  DROP TYPE "public"."enum__pages_v_blocks_promo_card_link_type";
  ...
  DROP TYPE "public"."enum_main_menu_tabs_nav_items_link_type";
  DROP TYPE "public"."enum_main_menu_tabs_link_type";
  DROP TYPE "public"."enum_main_menu_ctas_link_type";
